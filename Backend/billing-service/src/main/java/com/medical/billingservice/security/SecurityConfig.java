...
/**
 * Resource-server security for billing-service.
 *
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // Reading the clinic's money.
                        .requestMatchers(HttpMethod.GET, "/billing/**")
                        .hasAnyRole("BILLING", "ADMIN", "RECEPTIONIST")
                        // Taking a payment is front-desk work.
                        .requestMatchers("/billing/pay/**")
                        .hasAnyRole("BILLING", "ADMIN", "RECEPTIONIST")
                        // Everything else that writes, whatever the verb.
                        // Enumerating methods here is what let a patient token
                        // refund an invoice through the gateway, so this rule
                        // deliberately matches every remaining method.
                        .requestMatchers("/billing/**").hasAnyRole("BILLING", "ADMIN")
